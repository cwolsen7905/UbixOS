# The include file <ubix.own.mk> set common variables for owner,
...
.if !target(__<ubix.own.mk>__)
__<ubix.own.mk>__:

.include <ubix.opts.mk>		# options now here or src.opts.mk
...
# Compat for the moment -- old ubix.own.mk only included this when _WITHOUT_SRCCONF
# wasn't defined. ubix.ports.mk and friends depend on this behavior. Remove in 12.
.if !defined(_WITHOUT_SRCCONF)
.include <ubix.compiler.mk>
.endif # !_WITHOUT_SRCCONF

.endif	# !target(__<ubix.own.mk>__)
