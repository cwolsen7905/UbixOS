...
#
# Makefiles must include ubix.opts.mk after defining specific MK_FOO options that
# are applicable for that Makefile (typically there are none, but sometimes there
# are exceptions). Recursive makes usually add MK_FOO=no for options that they wish
# to omit from that make.
#
# Makefiles must include ubix.mkopt.mk before they test the value of any MK_FOO
# variable.
#
# Makefiles may also assume that this file is included by ubix.own.mk should it
# need variables defined there prior to the end of the Makefile where
# ubix.{subdir,lib.bin}.mk is traditionally included.
#
...
# Only these options are used by ubix.*.mk. KERBEROS and OPENSSH are
