# The include file <ubix.init.mk> includes <ubix.opts.mk>,
# ../Makefile.inc and <ubix.own.mk>; this is used at the
# top of all <ubix.*.mk> files that actually "build something".
# ubix.opts.mk is included early so Makefile.inc can use the
# MK_FOO variables.

.if !target(__<ubix.init.mk>__)
__<ubix.init.mk>__:
.include <ubix.opts.mk>
...
.endif	# !target(__<ubix.init.mk>__)
