# The include file <ubix.libnames.mk> define library names.
# Other include files (e.g. ubix.prog.mk, ubix.lib.mk) include this
# file where necessary.

.if !target(__<ubix.init.mk>__)
.error ubix.libnames.mk cannot be included directly.
.endif
