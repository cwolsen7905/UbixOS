...
#
# You must include ubix.test.mk instead of this file from your Makefile.
#
...
.if !target(__<ubix.test.mk>__)
.error tap.test.mk cannot be included directly.
.endif

# List of C, C++ and shell test programs to build.
#
# Programs listed here are built according to the semantics of ubix.prog.mk for
...
# exist in ubix.prog.mk along the support for SCRIPTS.  Move it there if
