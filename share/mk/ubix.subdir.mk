# The include file <ubix.subdir.mk> contains the default targets
...
.if !target(__<ubix.subdir.mk>__)
__<ubix.subdir.mk>__:
...
# .MAKE.DEPENDFILE==/dev/null is set by ubix.dep.mk to avoid reading
# Makefile.depend
