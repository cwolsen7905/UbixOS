...
static uInt32 _gp8(void *p)
{
	return *(uInt8 *)p;
}
static void _sp8(void *p, uInt32 c)
{
	*(uInt8 *)p = (uInt8)c;
}
static uInt32 _gp16(void *p)
{
	return *(uInt16 *)p;
}
static void _sp16(void *p, uInt32 c)
{
	*(uInt16 *)p = (uInt16)c;
}
...
static uInt32 _gp32(void *p)
{
	return *(uInt32 *)p;
}
static void _sp32(void *p, uInt32 c)
{
	*(uInt32 *)p = c;
}
...
const static ogRGBA8 DEFAULT_PALETTE[256] = {
    {0, 0, 0, 255},                                                                         // 0
    {0, 0, 170, 255},     {0, 170, 0, 255},     {0, 170, 170, 255},                         // 3
    {170, 0, 0, 255},     {170, 0, 170, 255},   {170, 85, 0, 255},    {170, 170, 170, 255}, // 7
    {85, 85, 85, 255},    {85, 85, 255, 255},   {85, 255, 85, 255},   {85, 255, 255, 255},  // 11
    {255, 85, 85, 255},   {255, 85, 255, 255},  {255, 255, 85, 255},  {255, 255, 255, 255}, // 15
    {16, 16, 16, 255},                                                                      // 16
    {32, 32, 32, 255},    {48, 48, 48, 255},    {64, 64, 64, 255},    {80, 80, 80, 255},    {96, 96, 96, 255},
    {112, 112, 112, 255}, {128, 128, 128, 255}, {144, 144, 144, 255}, {160, 160, 160, 255}, {176, 176, 176, 255},
    {192, 192, 192, 255}, {208, 208, 208, 255}, {224, 224, 224, 255}, {240, 240, 240, 255}, {255, 255, 255, 255}, // 31
    {59, 0, 0, 255},                                                                                              // 32
    {79, 0, 0, 255},      {103, 0, 0, 255},     {123, 0, 0, 255},     {143, 7, 7, 255},     {167, 7, 7, 255},
    {187, 11, 11, 255},   {211, 15, 15, 255},   {231, 19, 19, 255},   {255, 27, 27, 255},   {255, 59, 59, 255},
    {255, 91, 91, 255},   {255, 119, 119, 255}, {255, 151, 151, 255}, {255, 183, 183, 255}, {255, 215, 215, 255},
    {55, 55, 0, 255}, // 48
    {71, 71, 0, 255},     {87, 87, 0, 255},     {103, 103, 7, 255},   {119, 119, 7, 255},   {135, 135, 11, 255},
    {155, 155, 19, 255},  {171, 171, 23, 255},  {187, 187, 31, 255},  {203, 203, 35, 255},  {219, 219, 43, 255},
    {239, 239, 59, 255},  {255, 255, 63, 255},  {255, 255, 127, 255}, {255, 255, 187, 255}, {255, 255, 255, 255},
    {0, 43, 0, 255}, // 64
    {0, 63, 0, 255},      {0, 83, 0, 255},      {0, 103, 0, 255},     {7, 127, 7, 255},     {7, 147, 7, 255},
    {11, 167, 11, 255},   {15, 187, 15, 255},   {19, 211, 19, 255},   {27, 231, 27, 255},   {59, 235, 59, 255},
    {91, 239, 91, 255},   {127, 239, 127, 255}, {159, 243, 159, 255}, {195, 247, 195, 255}, {231, 251, 231, 255},
    {0, 55, 55, 255}, // 80
    {0, 71, 71, 255},     {0, 87, 87, 255},     {7, 103, 103, 255},   {7, 119, 119, 255},   {11, 135, 135, 255},
    {19, 155, 155, 255},  {23, 171, 171, 255},  {31, 187, 187, 255},  {35, 203, 203, 255},  {43, 219, 219, 255},
    {51, 235, 235, 255},  {63, 255, 255, 255},  {127, 255, 255, 255}, {187, 255, 255, 255}, {255, 255, 255, 255},
    {15, 15, 55, 255}, // 96
    {19, 19, 79, 255},    {27, 27, 103, 255},   {31, 31, 127, 255},   {35, 35, 155, 255},   {39, 39, 179, 255},
    {43, 43, 203, 255},   {47, 47, 227, 255},   {51, 51, 255, 255},   {71, 71, 255, 255},   {91, 91, 255, 255},
    {111, 111, 255, 255}, {131, 131, 255, 255}, {151, 151, 255, 255}, {175, 175, 255, 255}, {195, 195, 255, 255},
    {59, 51, 59, 255}, // 112
    {79, 63, 79, 255},    {103, 71, 103, 255},  {123, 75, 123, 255},  {143, 75, 143, 255},  {167, 71, 167, 255},
    {187, 67, 187, 255},  {211, 55, 211, 255},  {231, 43, 231, 255},  {255, 27, 255, 255},  {255, 59, 255, 255},
    {255, 91, 255, 255},  {255, 119, 255, 255}, {255, 151, 255, 255}, {255, 183, 255, 255}, {255, 215, 255, 255},
    {59, 51, 59, 255}, // 128
    {71, 59, 71, 255},    {83, 71, 83, 255},    {95, 83, 95, 255},    {111, 95, 111, 255},  {123, 103, 123, 255},
    {135, 115, 135, 255}, {147, 127, 147, 255}, {163, 139, 163, 255}, {175, 151, 175, 255}, {187, 159, 187, 255},
    {203, 171, 203, 255}, {215, 183, 215, 255}, {227, 191, 227, 255}, {239, 203, 239, 255}, {255, 215, 255, 255},
    {55, 27, 27, 255}, // 144
    {71, 35, 35, 255},    {91, 43, 43, 255},    {107, 55, 55, 255},   {127, 67, 67, 255},   {143, 75, 75, 255},
    {163, 87, 87, 255},   {179, 99, 99, 255},   {199, 111, 111, 255}, {203, 127, 127, 255}, {211, 139, 139, 255},
    {219, 159, 159, 255}, {223, 175, 175, 255}, {231, 191, 191, 255}, {239, 211, 211, 255}, {247, 231, 231, 255},
    {91, 63, 27, 255}, // 160
    {111, 75, 31, 255},   {127, 87, 39, 255},   {147, 103, 43, 255},  {167, 115, 51, 255},  {187, 127, 55, 255},
    {207, 139, 63, 255},  {227, 155, 67, 255},  {247, 167, 75, 255},  {247, 175, 95, 255},  {247, 183, 119, 255},
    {247, 195, 139, 255}, {247, 203, 159, 255}, {247, 215, 183, 255}, {247, 227, 203, 255}, {251, 239, 227, 255},
    {63, 63, 31, 255}, // 176
    {75, 75, 35, 255},    {87, 87, 43, 255},    {99, 99, 51, 255},    {115, 115, 55, 255},  {127, 127, 63, 255},
    {139, 139, 67, 255},  {151, 151, 75, 255},  {167, 167, 83, 255},  {175, 175, 95, 255},  {183, 183, 107, 255},
    {191, 191, 123, 255}, {203, 203, 139, 255}, {211, 211, 159, 255}, {219, 219, 175, 255}, {231, 231, 195, 255},
    {27, 59, 47, 255}, // 192
    {31, 75, 59, 255},    {39, 87, 67, 255},    {47, 103, 79, 255},   {55, 119, 91, 255},   {59, 135, 99, 255},
    {67, 151, 111, 255},  {71, 167, 119, 255},  {79, 183, 127, 255},  {87, 199, 139, 255},  {91, 215, 147, 255},
    {99, 231, 155, 255},  {127, 235, 183, 255}, {163, 239, 211, 255}, {195, 243, 231, 255}, {231, 251, 247, 255},
    {23, 55, 55, 255}, // 208
    {31, 71, 71, 255},    {39, 87, 87, 255},    {47, 103, 103, 255},  {55, 119, 119, 255},  {67, 139, 139, 255},
    {75, 155, 155, 255},  {87, 171, 171, 255},  {99, 187, 187, 255},  {111, 203, 203, 255}, {123, 223, 223, 255},
    {143, 227, 227, 255}, {163, 231, 231, 255}, {183, 235, 235, 255}, {203, 239, 239, 255}, {227, 247, 247, 255},
    {39, 39, 79, 255}, // 224
    {47, 47, 91, 255},    {55, 55, 107, 255},   {63, 63, 123, 255},   {71, 71, 139, 255},   {79, 79, 151, 255},
    {87, 87, 167, 255},   {99, 99, 183, 255},   {107, 107, 199, 255}, {123, 123, 203, 255}, {139, 139, 211, 255},
    {155, 155, 219, 255}, {171, 171, 223, 255}, {187, 187, 231, 255}, {207, 207, 239, 255}, {227, 227, 247, 255},
    {63, 27, 63, 255}, // 240
    {75, 31, 75, 255},    {91, 39, 91, 255},    {103, 47, 103, 255},  {119, 51, 119, 255},  {131, 59, 131, 255},
    {147, 67, 147, 255},  {163, 75, 163, 255},  {175, 83, 175, 255},  {191, 91, 191, 255},  {199, 107, 199, 255},
    {207, 127, 207, 255}, {215, 147, 215, 255}, {223, 171, 223, 255}, {231, 195, 231, 255}, {243, 219, 243, 255}};
...
bool ogSurface::ClipLine(int32 &x1, int32 &y1, int32 &x2, int32 &y2)
{
	...
	if (((uint32_t)tx1 > maxX) || ((uInt32)tx2 > maxX))
		return false;
...
void ogSurface::ogArc(int32 xCenter, int32 yCenter, uint32_t radius, uint32_t sAngle, uInt32 eAngle, uInt32 colour)
{
	int32 p;
	uint32_t x, y, tmp;
	double alpha;
...
bool ogSurface::ogClone(ogSurface &src)
{
	...
	if (!ogCreate(src.maxX + 1, src.maxY + 1, pixFmt))
		return false;
...
void ogSurface::ogCopy(ogSurface &src)
{
	...
	if (pixFmtID != src.pixFmtID)
	{
		if (src.bytesPerPix == 1)
		{
			for (xx = 0; xx < 256; xx++)
				pixMap[xx] =
				    ogPack(src.pal[xx].red, src.pal[xx].green, src.pal[xx].blue, src.pal[xx].alpha);
...
void ogSurface::ogCopyBuf(int32 dX1, int32 dY1, ogSurface &src, int32 sX1, int32 sY1, int32 sX2, int32 sY2)
{
	...
	if (((uint32_t)sX1 > src.maxX) || ((uInt32)sX2 > src.maxX) || ((uint32_t)sY1 > src.maxY) ||
	    ((uInt32)sY2 > src.maxY))
		return;
	...
	if (pixFmtID != src.pixFmtID)
	{
		...
		else
		{
			...
			for (yy = 0; yy < yCount; yy++)
				for (xx = 0; xx < xCount; xx++)
					RawSetPixel(
					    dX1 + xx, dY1 + yy, pc.ConvPix(src.RawGetPixel(sX1 + xx, sY1 + yy)));
...
bool ogSurface::ogCreate(uint32_t _xRes, uInt32 _yRes, ogPixelFmt _pixFormat)
{
	...
	do
	{
		...
		{
			pixFmtID = (redFieldPosition) | (greenFieldPosition << 8) | (blueFieldPosition << 16) |
...
/* Even-odd point-in-polygon (PNPOLY crossing test) for the AA fill sampler. */
static bool og_pt_in_poly(float x, float y, uint32_t n, const ogPoint2d *p)
{
	bool inside = false;
	for (uint32_t i = 0, j = n - 1; i < n; j = i++)
	{
		float xi = (float)p[i].x, yi = (float)p[i].y;
		float xj = (float)p[j].x, yj = (float)p[j].y;
...
void ogSurface::ogFillPolygon(uint32_t numPoints, ogPoint2d *polyPoints, uInt32 colour)
{
	...
	/* Anti-aliased path for UI-scale polygons (triangles, suit pips, arrows,
	 * icons): 4x4-supersample each pixel's coverage against the even-odd interior
	 * and composite through the gamma-correct ogAACoverage — smoothing the sloped
	 * edges the hard scanline fill (below) leaves jagged.  A bounding-box area cap
	 * bounds the O(area*16) cost; larger polygons fall through to the fast fill. */
	{
		int32 minx = polyPoints[0].x, maxx = polyPoints[0].x;
		int32 miny = polyPoints[0].y, maxy = polyPoints[0].y;
		for (uint32_t i = 1; i < numPoints; i++)
		{
			if (polyPoints[i].x < minx)
				minx = polyPoints[i].x;
			if (polyPoints[i].x > maxx)
				maxx = polyPoints[i].x;
			if (polyPoints[i].y < miny)
				miny = polyPoints[i].y;
			if (polyPoints[i].y > maxy)
				maxy = polyPoints[i].y;
		}
		if (minx < 0)
			minx = 0;
		...
		if (maxy > (int32)maxY)
			maxy = (int32)maxY;
		long area = (maxx >= minx && maxy >= miny) ? (long)(maxx - minx + 1) * (maxy - miny + 1) : 0;
		if (area > 0 && area <= 65536L)
		{
			const int N = 4;
				...
				for (int32 x = minx; x <= maxx; x++)
				{
					...
					for (int sy = 0; sy < N; sy++)
						for (int sx = 0; sx < N; sx++)
							if (og_pt_in_poly((float)x + (sx + 0.5f) / N,
							                  (float)y + (sy + 0.5f) / N,
							                  numPoints,
							                  polyPoints))
								hits++;
					if (hits)
						ogAACoverage(x, y, colour, hits * 255 / (N * N));
				}
			return;
		}
	}
		...
		for (int k = 0; k < 4; k++)
			for (int32 i = 0; i <= r + 1; i++)
				for (int32 j = 0; j <= r + 1; j++)
				{
					...
					int32 cov = (c >= 1.0f) ? 255 : (int32)(c * 255.0f + 0.5f);
					ogAACoverage(
					    cor[k].ccx + cor[k].qx * i, cor[k].ccy + cor[k].qy * j, colour, cov);
				}
	}
	else
	{
...
uint32_t ogSurface::ogGetPixel(int32 x, int32 y)
{
	...
	if (((uint32_t)x > maxX) || ((uInt32)y > maxY))
		return ogGetTransparentColor();
...
uint32_t ogSurface::ogPack(uInt8 red, uInt8 green, uInt8 blue)
{
	...
	{
		case 4:
			colour = ((red << redFieldPosition) | (green << greenFieldPosition) |
			          (blue << blueFieldPosition) | (ogGetAlpha() << alphaFieldPosition));
			break;
		case 3:
			colour =
			    ((red << redFieldPosition) | (green << greenFieldPosition) | (blue << blueFieldPosition));
			break;
		case 2:
...
uint32_t ogSurface::ogPack(uInt8 red, uInt8 green, uInt8 blue, uInt8 alpha)
{
	...
	switch (bytesPerPix)
	{
		case 4:
			colour = ((red << redFieldPosition) | (green << greenFieldPosition) |
			          (blue << blueFieldPosition) | (alpha << alphaFieldPosition));
			break;
		case 3:
			colour =
			    ((red << redFieldPosition) | (green << greenFieldPosition) | (blue << blueFieldPosition));
...
void ogSurface::ogScaleBuf(
    int32 dX1, int32 dY1, int32 dX2, int32 dY2, ogSurface &src, int32 sX1, int32 sY1, int32 sX2, int32 sY2)
{
...
void ogSurface::ogSpline(uint32_t numPoints, ogPoint2d *points, uInt32 segments, uint32_t colour)
{
	...
	do
	{
		...
		for (i = 0; (uint32_t)i < numPoints - 1; i++)
		{
			for (j = 0; (uint32_t)j <= segments; j++)
			{
				...
				t = (part - zc[i]) / u[i];
				part = t * points[i + 1].y + (1.0 - t) * points[i].y +
				       u[i] * u[i] * (f(t) * py[i + 1] + f(1.0 - t) * py[i]) / 6.0;
				//        y = Round(part);
				y = static_cast<int32>(part + 0.5f);
				part = zc[i] - (((zc[i] - zc[i + 1]) / segments) * j);
				t = (part - zc[i]) / u[i];
				part = t * points[i + 1].x + (1.0 - t) * points[i].x +
				       u[i] * u[i] * (f(t) * px[i + 1] + f(1.0 - t) * px[i]) / 6.0;
...
void ogSurface::ogUnpack(uint32_t colour, uInt8 &red, uInt8 &green, uInt8 &blue)
{
	switch (bytesPerPix)
	{
		...
		case 2:
			...
			if (red != 0)
				red += ogPixelFmt::OG_MASKS[redShifter];
			if (green != 0)
				green += ogPixelFmt::OG_MASKS[greenShifter];
			if (blue != 0)
				blue += ogPixelFmt::OG_MASKS[blueShifter];
			break;
		case 1:
	...
	switch (bytesPerPix)
	{
		...
		case 2:
			...
			if (alphaShifter != 8)
			{
				...
				if (alpha != 0)
					alpha += ogPixelFmt::OG_MASKS[alphaShifter];
			}
			else
				alpha = ogGetAlpha();
