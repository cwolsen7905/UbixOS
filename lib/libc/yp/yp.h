...
extern  void ypprog_1(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void ypprog_2(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void yppush_xfrrespprog_1(struct svc_req *rqstp, register SVCXPRT *transp);
...
#else /* K&R C */
extern  void yppush_xfrrespprog_1();
#define	YPPUSHPROC_NULL ((unsigned long)(0))
