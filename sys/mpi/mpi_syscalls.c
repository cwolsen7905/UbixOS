...
int sys_mpiWaitMessage(struct thread *td, struct sys_mpiWaitMessage_args *args)
{
	td->td_retval[0] = mpi_waitMessage(args->name, (mpi_message_t *)args->msg, args->timeout);
	return (0x0);
}
