/* config.h for the uBixOS bmake port — generated by bmake's configure on the
   host, then adapted for musl (see the 3 disabled macOS-only features below).
   Authored this way because configure can't run target test-programs under
   -nostdlib.  See tools/ports/bmake/README.md. */
...
/* Define to 1 if you have the declaration of `sys_siglist', and to 0 if you
   don't. */
/* #undef HAVE_DECL_SYS_SIGLIST */ /* musl: no sys_siglist */
...
/* #undef HAVE_MMAP */ /* uBixOS: file-backed mmap of makefiles SIGABRTs (self-hosting Phase 2); use read() */
...
/* #undef HAVE_SYSCTL */ /* musl: no sysctl(2) */
...
/* #undef HAVE_SYS_SYSCTL_H */ /* musl: deprecated stub */
