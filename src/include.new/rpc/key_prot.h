...
extern  void key_prog_1(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void key_prog_2(struct svc_req *rqstp, register SVCXPRT *transp);
