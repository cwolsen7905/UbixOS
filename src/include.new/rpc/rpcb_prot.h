...
extern  void rpcbprog_3(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void rpcbprog_4(struct svc_req *rqstp, register SVCXPRT *transp);
