...
extern  void rstatprog_3(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void rstatprog_2(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void rstatprog_1(struct svc_req *rqstp, register SVCXPRT *transp);
