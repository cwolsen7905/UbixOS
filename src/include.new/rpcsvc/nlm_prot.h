...
extern  void nlm_prog_0(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void nlm_prog_1(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void nlm_prog_3(struct svc_req *rqstp, register SVCXPRT *transp);
...
#if defined(__STDC__) || defined(__cplusplus)
extern  void nlm_prog_4(struct svc_req *rqstp, register SVCXPRT *transp);
