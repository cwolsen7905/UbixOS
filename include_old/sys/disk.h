...
#define DIOCGSECTORSIZE	_IOR('d', 128, uInt32)
	/*-
...
#define DIOCGFWSECTORS	_IOR('d', 130, uInt32)	/* Get firmware sectorcount */
	/*-
...
#define DIOCGFWHEADS	_IOR('d', 131, uInt32)	/* Get firmware headcount */
	/*-
...
#define DIOCSKERNELDUMP _IOW('d', 133, uInt32)	/* Set/Clear kernel dumps */
	/*-
